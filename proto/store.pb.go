...
var file_store_proto_rawDesc = []byte{
	...
	0x73, 0x32, 0xba, 0x01, 0x0a, 0x0d, 0x52, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x65, 0x72, 0x76,
	...
	0x4b, 0x65, 0x79, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x26,
...
var file_store_proto_depIdxs = []int32{
	6, // 0: rstore.ReadResponse.value:type_name -> google.protobuf.Any
	6, // 1: rstore.WriteRequest.value:type_name -> google.protobuf.Any
	...
	1, // 5: rstore.RStoreService.Read:output_type -> rstore.ReadResponse
	3, // 6: rstore.RStoreService.Write:output_type -> rstore.WriteResponse
	5, // 7: rstore.RStoreService.GetKeys:output_type -> rstore.GetKeysResponse
